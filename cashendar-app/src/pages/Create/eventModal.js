                            ...
                            <div>
                                {labelsColorClasses.map((lblClass, i) => (
                                    <span
                                        ...
                                        onClick={() => {
                                            {
                                                setSelColor(lblClass);
                                            }
                                            {
                                                lblClass === selColor &&
                                                labelsColorIsSelected[i] ===
                                                    true
                                                    ? (labelsColorIsSelected[
                                                          i
                                                      ] = false)
                                                    : (labelsColorIsSelected[
                                                          i
                                        ...
                                        className={
                                            lblClass === selColor &&
                                            labelsColorIsSelected[i]
                                                ? `border border-5 top-sticky float-left d-inline-flex m-3 p-3 bg-${lblClass} rounded-circle text-white`
                                                : `top-sticky float-left d-inline-flex m-3 p-3 bg-${lblClass} rounded-circle text-white`
                                        }
                                    ></span>
                                ))}
                            </div>
